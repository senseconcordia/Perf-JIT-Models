...
identified_perf_commits = ["03a9343d5798384b66fbd21e1e028acaf55b00e9",
...
manually_labelled = ["03a9343d5798384b66fbd21e1e028acaf55b00e9",
    "5877f20f9c3f6f0afa505715e9a2ee312475af17",
    "638801cce16fc1dc3259c541dc30a599faaddda1",
    "42307e3c3abbfe0b83d9a2581deba327435b910f",
    "892ade689f9bcce76daae8f66fc00a49bee8548e",
...
count = 0
with open('hadoop.csv') as inf, open('corrected_hadoop.csv', 'w') as outf:
    ...
    for commit in commits:
        ...
        if commit['commit_hash'] in identified_perf_commits and commit['commit_hash'] in manually_labelled:
            ...
            'rexp':commit['rexp'],
            'sexp':commit['sexp'],
            'glm_probability':commit['glm_probability'],
            'commit':commit['rf_probability'],
            'repository_id':commit['repository_id'],
            'issue_id':commit['issue_id'],
            'issue_date':commit['issue_date'],
            'issue_type':commit['issue_type'],
            ...
            'classification':commit['classification'],
            'linked':commit['linked'],
            'contains_bug':commit['contains_bug'],
            'fixes':commit['fixes'],
            'ns':commit['ns'],
            'nd':commit['nd'],
            'nf':commit['nf'],
...
with open('hadoop.csv') as inf, open('raw_hadoop.csv', 'w') as outf:
    commits = csv.DictReader(inf, delimiter=',')
    writer = csv.DictWriter(outf, fieldnames=commits.fieldnames, extrasaction='ignore',)
    writer.writeheader()  # For writing header
    for commit in commits:
